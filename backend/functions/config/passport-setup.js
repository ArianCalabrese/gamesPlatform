...
passport.use(
  new SteamStrategy(
    {
      returnURL: "https://southamerica-east1-atiweb.cloudfunctions.net/getServers/api/users/steam/return",
      realm: "https://southamerica-east1-atiweb.cloudfunctions.net/getServers/api/users/",
